...
public class GooglePlacesAutoComplete extends ArrayAdapter implements Filterable {
    ...
    public GooglePlacesAutoComplete(@NonNull Context context, int resource) {
    ...
    private void saveArray(String[] toArray, String predictionsArray, Context context) {
