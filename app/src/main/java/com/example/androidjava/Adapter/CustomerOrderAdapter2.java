...
public class CustomerOrderAdapter2 extends RecyclerView.Adapter<CustomerOrderAdapter2.CustomerOrderAdapterViewHolder2> {
    Activity activity;
    List<mOrderCustomerOnline> list;
    Gson gson;
    public CustomerOrderAdapter2(Activity activity, List<mOrderCustomerOnline> list) {
    ...
    @NonNull
    @Override
    public CustomerOrderAdapterViewHolder2 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = activity.getLayoutInflater();
        View view = inflater.inflate(R.layout.custom_one_order_item_customer_order_history2, parent, false);
        return new CustomerOrderAdapterViewHolder2(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CustomerOrderAdapterViewHolder2 holder, int position) {
//        int pos = 0;
...
//        });
    ...
    class CustomerOrderAdapterViewHolder2 extends RecyclerView.ViewHolder {
        TextView txtOrderId, txtOrderDate, txtOrderStatus, txtOrderRemark, txtOrderAmount;
        LinearLayout linearLayout;
        public CustomerOrderAdapterViewHolder2(@NonNull View itemView) {
            super(itemView);
